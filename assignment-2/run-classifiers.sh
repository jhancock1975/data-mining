...
COST_MATRIX_FILE=/home/john/Documents/school/fau/2014-fall/data-mining/assignments/data-mining/assignment-2/cost-matrices.txt
let NUM_COST_MATRICES=$(wc -l $COST_MATRIX_FILE)
COUNTER=0
while [  $COUNTER -lt $NUM_COST_MATRICES ]; do
	COST_MATRIX=$(sed $i'q;d' cost-matrices.txt);
